...
export const metadata = createPageMetadata({
  title: "Legendary F1 Cars in 3D: RB19, W11, F2004 & More",
  description: "Explore detailed 3D exhibits of the Red Bull RB19, Mercedes W11, Ferrari F2004, McLaren MP4/4 and Williams FW14B, alongside the stories of Verstappen, Hamilton and Schumacher.",
  ...
  return (
    <div className="bg-bg-primary text-text-primary">
      <header className="border-b border-line px-4 py-7 sm:px-6 sm:py-9 lg:px-8">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-text-secondary sm:text-base">Five legendary cars. Five world champions. Get closer to the machines behind the moments.</p>
      </header>
